...
static int save_avio_options(AVFormatContext *s)
{
    ...
    static const char * const opts[] = {
        "headers", "http_proxy", "user_agent", "cookies", "referer", "rw_timeout", "icy", "http_host", NULL };
...
static const AVOption hls_options[] = {
    ...
    {"http_seekable", "Use HTTP partial requests, 0 = disable, 1 = enable, -1 = auto",
		...
		/*
	{ "http_host", "set custom HTTP host, can override built in default hostname",
		OFFSET(hostname), AV_OPT_TYPE_STRING, { .str = NULL }, 0, 0, FLAGS },
		*/
    {NULL}
};
